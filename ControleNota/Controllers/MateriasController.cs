...
namespace ControleNota.Controllers
{
    public class MateriasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Materias.Include(m => m.Professor);
        ...
        public async Task<IActionResult> Create([Bind("MateriaId,Nome,CargaHoraria,ProfessorId")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MateriaId,Nome,CargaHoraria,ProfessorId")] Materia materia)
        {
