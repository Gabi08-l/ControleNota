...
namespace ControleNota.Controllers
{
    ...
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfessorId,Nome,Email")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfessorId,Nome,Email")] Professor professor)
        {
